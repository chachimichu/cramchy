(function(){
  const VERSION='2026-09-10-grades-rounding-39';
  ...
  function refreshStyles(){
    const sheets=['styles.css','design-v3.css','home-hero-v4.css','home-hierarchy-v5.css','home-command-v6.css','polish-v7.css','theme-gradients-v8.css','typography-polish-v17.css','home-planner-reminders-v23.css','mobile-shell-fix-v30.css','grades-nu-polish-v1.css','grades-hierarchy-v37.css','grades-transition-v38.css'];
  ...
  refreshStyles()
    ...
    .then(()=>loadScript('grades-transition-v38.js?v='+VERSION))
